...
- Round-3 state art (prompts in `design/PROMPTS-gemini-3.md`) replaces the placeholder PNGs under `assets/states/` plus the new tool/ingredient/topping files; placeholders were generated by a throwaway script and must not ship.

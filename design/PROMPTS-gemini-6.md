...
> **สถานะ: แผ่น C ทำแล้ว (2026-09-25)** ตัดเป็น `assets/coins/note50.png`, `note100.png`, `assets/shop/cakeslice.png`, `basket.png`, `cup.png`, `register.png` (แบงก์ 50 แก้วน้ำ และตะกร้าเกินช่องนิดหน่อย จึงตัดตามขอบจริง และลบพื้นขาวในหูตะกร้าเอง) ; แผ่น D ทำแล้วเช่นกัน ตัดเป็น `assets/decor/` อีก 10 ชิ้น (กระถางแขวนกับรูปในกรอบตัดใหม่ตามขอบจริง, ลบพื้นขาวในช่องโปร่งของเก้าอี้กลม ไฟประดับ ชุดน้ำชา หูแขวนรูป) — ใช้ในเกมตั้งแต่ v39

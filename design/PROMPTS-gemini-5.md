...
> **สถานะ: ทำแล้ว (2026-09-23)** — ครบ 4 รูป ตัดเป็น `assets/coins/` (5), `assets/shop/` (11), `assets/decor/` (10), `assets/shop.jpg`, `assets/market.jpg` หมายเหตุ: ชั้นวาง แบงก์ 20 ถุง กระดานเมนู ผ้าปูโต๊ะ กันสาด และธงราว วาดเกินช่องตาราง จึงตัดใหม่ตามขอบของชิ้นจริงแทน `--grid` และลบพื้นขาวช่องกลางชั้นวางเอง
